class PlayerArrow {
  ...
  display() {
    ...
    /*if (this.body.velocity.x > 0 || this.body.position.x > 400) { //WRONG CODE (Line 61 this.trajectory)
      var position = [this.body.position.x, this.body.position.y];
      trajectory.push(position);
    }*/

    /*if (this.body.velocity.x < 0 && this.body.position.x < 400) {  //WRONG CODE (NO PUSH)
      var position = [this.body.position.x, this.body.position.y];
      this.trajectory(position);
    }*/

    /*if (this.body.velocity.x > 0 this.body.position.x > 400) { //WRONG CODE (NO && OR ||)
      var position = [this.body.position.x, this.body.position.y];
    ...
    for (var i = 0; i < this.trajectory.length; i++) {
      ...
      //ellipse(trajectory[i][0], trajectory[i][1], 5, 5); //WRONG CODE
